...
export function fnDelonAuthConfig(): DelonAuthConfig {
  // store_key:location.host+
  return {
    ...new DelonAuthConfig(),
    ...({
      store_key: location.host + location.pathname,
      login_url: '/passport/keycloak',
      ignores: [/\/login/, /assets\//, /passport\//, /\/public/, /public\//],
      executeOtherInterceptors: environment.executeOtherInterceptors,
    } as DelonAuthConfig),
  };
}
...
export function fnDelonFormConfig(): DelonFormConfig {
  return Object.assign(new DelonFormConfig(), {
    uiEmailSuffixes: ['accenture.com', 'qq.com', '126.com'],
  } as DelonFormConfig);
}
