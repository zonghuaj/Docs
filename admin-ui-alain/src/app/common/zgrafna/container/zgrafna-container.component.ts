...
import {ZGContainer, ZGData, ZGText} from "@app/common/zgrafna/zgrafna.entites";
import {ZGrafnaService} from "@app/common/zgrafna/zgrafna.service";
...
export class ZGrafnaContainerComponent implements OnInit, OnDestroy {
  ...
  constructor(private grafnaService: ZGrafnaService,
