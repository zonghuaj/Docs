...
import {ArtifRuntimeParam} from "../../artifactory.entities";
import {InputBoolean} from "ng-zorro-antd";

@Component({
  selector: 'artifactory-runtimeparams-table',
  templateUrl: './runtime-params-table.component.html',
  styleUrls: ['./runtime-params-table.component.less'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RuntimeParamsTableComponent extends BaseFormComponent<ArtifRuntimeParam[]> {
  @Input() title;
  @Input() formKey;
