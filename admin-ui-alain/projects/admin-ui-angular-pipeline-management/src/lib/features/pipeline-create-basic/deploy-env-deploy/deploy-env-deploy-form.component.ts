...
@Component({
  selector: 'deploy-env-deploy-form',
  templateUrl: './deploy-env-deploy-form.component.html',
  styleUrls: ['./deploy-env-deploy-form.component.less'],
  animations: [FadingAnim],
  encapsulation: ViewEncapsulation.None
})
export class DeployEnvDeployComponentFormComponent extends BaseFormComponent<any> {
  CPU_VALS = [
