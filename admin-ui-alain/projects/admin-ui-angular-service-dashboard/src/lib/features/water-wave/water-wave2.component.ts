...
@Component({
  selector: 'g2-water-wave2',
  exportAs: 'g2WaterWave2',
...
export class G2WaterWaveComponent2 implements OnDestroy, OnChanges, OnInit {
  ...
  private updateRadio() {
    ...
    // I don't know why this 'ratio' doesn't performed correctly, force it to '1'
